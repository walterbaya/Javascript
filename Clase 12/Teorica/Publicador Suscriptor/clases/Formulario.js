class Formulario {
    ...
    enviar(e) {
        ...
        if (!textArea.value.trim()) {
            ...
            console.log("hicimos un fetch", textArea.value);
            this.dom.formu.reset();

            //Creamos un evento propio utilizando CustomEvent
            let clase = (this.nombreEvento == "envio_pro") ? "pro" : "contra";
            let evento = new CustomEvent(this.nombreEvento, {
                detail: {
                    texto: textArea.value,
                    clase //es lo mismo que clase:clase
                }
            });
